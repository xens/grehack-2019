...
import (
	...
	"grehack.fr/prechall19/echoip/http"
...
func main() {
	var opts struct {
		...
		IsItDown      bool     `short:"d" long:"is-it-down" description:"Enable Is It Down"`
	...
	if opts.IsItDown {
		log.Println("Enabling Is It Down")
		server.IsItDown = iputil.IsItDown
	}
